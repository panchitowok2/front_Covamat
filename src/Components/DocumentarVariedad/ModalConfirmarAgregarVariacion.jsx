...
function ModalConfirmarAgregarVariacion({showConfirmar, setShowConfirmar, setAgregarVariaciones, setFinalizarTransaccion}) {
...
export default ModalConfirmarAgregarVariacion;
